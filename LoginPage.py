...
class LoginPage:
    def __init__(self, window):
        ...
        # ============================ Login button ==============================
        # ========================================================================
        self.lgn_button = Button(self.lgn_frame, text='LOGIN', font=("yu gothic ui", 14, "bold"),
                                 width=20, bd=0, bg='#1E90FF', cursor='hand2',
                                 activebackground='#4682B4', fg='black')
        self.lgn_button.place(x=580, y=470)

        # ========================================================================
        # ============================ Forgot password ===========================
        # ========================================================================
        self.forgot_button = Button(self.lgn_frame, text="Forgot Password ?",
                                    font=("yu gothic ui", 11, "bold underline"), fg="black", relief=FLAT,
                                    activebackground="#040405", borderwidth=0, background="#040405",
                                    cursor="hand2")
        self.forgot_button.place(x=640, y=520)
        ...
        self.signup_button = Button(self.lgn_frame, text="SIGN UP", font=("yu gothic ui", 11, "bold"),
                                    bg="#32CD32", fg="black", activebackground="#228B22",
                                    cursor="hand2", borderwidth=0, width=12, height=1)
        self.signup_button.place(x=720, y=555)
